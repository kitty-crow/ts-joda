...
export class MonthDay extends TemporalAccessor {
    ...
    static now(zoneIdOrClock?: ZoneId | Clock): MonthDay {
        if (arguments.length === 0) {
            ...
            return MonthDay.nowClock(zoneIdOrClock as Clock);
        }
    }
    /**
     ...
     */
    static nowZoneId(zone: ZoneId): MonthDay {
     ...
     */
    static nowClock(clock: Clock): MonthDay {
    ...
    static of(monthOrNumber: Month | number, number: number): MonthDay {
        if (arguments.length === 2 && monthOrNumber instanceof Month) {
            ...
            return MonthDay.ofNumberNumber(monthOrNumber as number, number);
        }
    }
    /**
    ...
    static parse(text: string, formatter?: DateTimeFormatter): MonthDay {
        if (arguments.length === 1) {
            ...
            return MonthDay.parseStringFormatter(text, formatter as DateTimeFormatter);
        }
    }
    /**
...
export function _init(): void {
    PARSER = new DateTimeFormatterBuilder()
        ...
        .toFormatter();
    MonthDay.FROM = createTemporalQuery('MonthDay.FROM', (temporal: TemporalAccessor): MonthDay => {
