...
import { IllegalStateException } from "../errors.ts";
...
class Impl extends TemporalAdjuster {
    ...
    static FIRST_DAY_OF_MONTH: Impl;
    static LAST_DAY_OF_MONTH: Impl;
    static FIRST_DAY_OF_NEXT_MONTH: Impl;
    static FIRST_DAY_OF_YEAR: Impl;
    static LAST_DAY_OF_YEAR: Impl;
    static FIRST_DAY_OF_NEXT_YEAR: Impl;
    /**
     *
     * @param ordinal
     * @private
...
class DayOfWeekInMonth extends TemporalAdjuster {
     ...
     * @private
     */
    constructor(ordinal: number, dow: DayOfWeek) {
        super();
        this._ordinal = ordinal;
...
class RelativeDayOfWeek extends TemporalAdjuster {
     ...
     * @private
     */
    constructor(relative: number, dayOfWeek: DayOfWeek) {
        super();
        requireNonNull(dayOfWeek, 'dayOfWeek');
