 ...
 * @type {Object}
 */
export const IsoFields = {} as {
    DAY_OF_QUARTER: TemporalField;
    QUARTER_OF_YEAR: TemporalField;
    WEEK_OF_WEEK_BASED_YEAR: TemporalField;
    WEEK_BASED_YEAR: TemporalField;
    WEEK_BASED_YEARS: TemporalUnit;
    QUARTER_YEARS: TemporalUnit;
};
//-----------------------------------------------------------------------
...
class Field extends TemporalField {
     ...
     * @returns {boolean}
     */
    _isIso(_temporal: TemporalAccessor): boolean {
        return true;
    }
    /**
     *
     ...
     * @returns {ValueRange}
     */
    static _getWeekRangeByLocalDate(date: LocalDate): ValueRange {
     ...
     * @returns {number}
     */
    static _getWeekRangeByYear(wby: number): number {
     ...
     * @returns {number}
     */
    static _getWeek(date: LocalDate): number {
     ...
     * @returns {number}
     */
    static _getWeekBasedYear(date: LocalDate): number {
        let year = date.year();
...
class DAY_OF_QUARTER_FIELD extends Field {
     ...
     */
    override resolve(
        fieldValues: Map<TemporalField, number>,
        _partialTemporal: TemporalAccessor,
        ...
        fieldValues.delete(QUARTER_OF_YEAR);
        return date;
    }
}
/**
...
class WEEK_OF_WEEK_BASED_YEAR_FIELD extends Field {
    ...
    override resolve(
        ...
        fieldValues.delete(this);
        fieldValues.delete(WEEK_BASED_YEAR);
...
class Unit extends TemporalUnit {
     ...
     * @returns {Temporal}
     */
    addTo<T extends Temporal>(temporal: T, periodToAdd: number): T {
        switch (this) {
...
let DAY_OF_QUARTER: TemporalField;
let QUARTER_OF_YEAR: TemporalField;
let WEEK_OF_WEEK_BASED_YEAR: TemporalField;
let WEEK_BASED_YEAR: TemporalField;
let WEEK_BASED_YEARS: TemporalUnit;
let QUARTER_YEARS: TemporalUnit;
declare module "../LocalDate.ts" {
    interface LocalDate {
...
export function _init(): void {
     ...
     */
    LocalDate.prototype.isoWeekOfWeekyear = function (): number {
     ...
     */
    LocalDate.prototype.isoWeekyear = function (): number {
