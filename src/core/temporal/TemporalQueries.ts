...
export class TemporalQueries {
    static ZONE_ID: TemporalQuery<ZoneId | null>;
    static CHRONO: TemporalQuery<IsoChronology | null>;
    static PRECISION: TemporalQuery<TemporalUnit | null>;
    static ZONE: TemporalQuery<ZoneId | null>;
    static OFFSET: TemporalQuery<ZoneOffset | null>;
    static LOCAL_DATE: TemporalQuery<LocalDate | null>;
    static LOCAL_TIME: TemporalQuery<LocalTime | null>;
     ...
     */
    static zoneId(): TemporalQuery<ZoneId | null> {
     ...
     */
    static chronology(): TemporalQuery<IsoChronology | null> {
     ...
     */
    static localDate(): TemporalQuery<LocalDate | null> {
     ...
     */
    static localTime(): TemporalQuery<LocalTime | null> {
