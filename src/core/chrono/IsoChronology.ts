...
import { EnumMap } from "../format/EnumMap.ts";
...
export class IsoChronology extends Enum {
     ...
     */
    _updateResolveMap(fieldValues: EnumMap, field: ChronoField, value: number): void {
    ...
    resolveDate(fieldValues: EnumMap, resolverStyle: ResolverStyle): LocalDate | null {
