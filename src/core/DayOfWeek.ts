 ...
 */
import { DateTimeException, UnsupportedTemporalTypeException, NullPointerException } from "./errors.ts";
...
export class DayOfWeek extends TemporalAccessor {
    ...
    displayName(style: unknown, locale: unknown): string {
...
export function _init(): void {
    ...
    DayOfWeek.FROM = createTemporalQuery('DayOfWeek.FROM', (temporal: TemporalAccessor): DayOfWeek => {
