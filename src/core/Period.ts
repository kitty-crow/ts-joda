...
import { DateTimeException, UnsupportedTemporalTypeException, ArithmeticException, DateTimeParseException } from "./errors.ts";
...
*/
     ...
     */
    static _parse(text: string): Period {
    ...
    static _parseNumber(_text: string, str: string | undefined, negate: 1 | -1): number {
        if (str == null) {
            return 0;
        }
     ...
     * @return {Duration}
     */
    static create(years: number, months: number, days: number): Period {
