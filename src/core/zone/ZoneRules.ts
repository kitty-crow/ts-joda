 ...
 */
import { requireNonNull, abstractMethodFail } from "../assert.ts";
...
export class ZoneRules {
     ...
     */
    // eslint-disable-next-line no-unused-vars
    transition(localDateTime: LocalDateTime): ZoneOffsetTransition | null {
     ...
     */
    // eslint-disable-next-line no-unused-vars
    nextTransition(instant: Instant): ZoneOffsetTransition | null {
     ...
     */
    // eslint-disable-next-line no-unused-vars
    previousTransition(instant: Instant): ZoneOffsetTransition | null {
...
class Fixed extends ZoneRules {
    ...
    offsetOfInstant(_instant: Instant): ZoneOffset {
        return this._offset;
    }
    offsetOfEpochMilli(_epochMilli: number): ZoneOffset {
        return this._offset;
    }
    offsetOfLocalDateTime(_localDateTime: LocalDateTime): ZoneOffset {
        return this._offset;
    }
    validOffsets(_localDateTime: LocalDateTime): ZoneOffset[] {
        return [this._offset];
    }
    transition(_localDateTime: LocalDateTime): null {
        return null;
    }
    standardOffset(_instant: Instant): ZoneOffset {
        return this._offset;
    }
     ...
     * @return {boolean}
     */
    isValidOffset(_localDateTime: LocalDateTime, offset: ZoneOffset): boolean {
        return this._offset.equals(offset);
    }
    nextTransition(_instant: Instant): null {
        return null;
    }
    previousTransition(_instant: Instant): null {
        return null;
    }
    transitions(): never[] {
        return [];
    }
    transitionRules(): never[] {
        return [];
    }
    //-----------------------------------------------------------------------
    /**
