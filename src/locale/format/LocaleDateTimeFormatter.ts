 ...
 */
import { _ as jodaInternal, DateTimeFormatter, ChronoField, ResolverStyle, IsoChronology, } from '@js-joda/core';
// eslint-disable-next-line no-unused-vars
import Locale from "../Locale.ts";
import CldrDateTimeFormatterBuilder from "./cldr/CldrDateTimeFormatterBuilder.ts";
...
export default class LocaleDateTimeFormatter extends DateTimeFormatter {
     ...
     */
    override withLocale(locale: Locale): DateTimeFormatter {
...
export function _init(): void {
    const dow: { 1: string; 2: string; 3: string; 4: string; 5: string; 6: string; 7: string; } = {
        1: 'Mon',
        2: 'Tue',
        3: 'Wed',
        4: 'Thu',
    ...
    const moy: { 1: string; 2: string; 3: string; 4: string; 5: string; 6: string; 7: string; 8: string; 9: string; 10: string; 11: string; 12: string; } = {
        1: 'Jan',
        2: 'Feb',
        3: 'Mar',
        4: 'Apr',
