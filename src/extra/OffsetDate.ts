...
export class OffsetDate extends Temporal implements TemporalAdjuster {
    ...
    override _withAdjuster(adjuster: TemporalAdjuster): OffsetDate {
    ...
    override _withField(field: TemporalField, newValue: number): OffsetDate {
        requireNonNull(field, 'field');
        requireInstance(field, TemporalField, 'field');
        if (field instanceof ChronoField) {
    ...
    override _plusUnit(amountToAdd: number, unit: TemporalUnit): OffsetDate {
