...
export class YearWeek extends Temporal {
    ...
    protected override _withAdjuster(adjuster: TemporalAdjuster): YearWeek {
    ...
    protected override _withField(field: TemporalField, newValue: number): YearWeek {
        if (field === IsoFields.WEEK_OF_WEEK_BASED_YEAR) {
    ...
    protected override _plusUnit(amountToAdd: number, unit: TemporalUnit): YearWeek {
    ...
    protected override _minusUnit(amountToSubtract: number, unit: TemporalUnit): YearWeek {
